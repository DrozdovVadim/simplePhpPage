<div class="container">
    <div class="pagination">
        ...
        <?php if ($currentPage == $totalPages): ?>
            <a class="arrow-prev pagination__arrow" href="<?= $link(1) ?>">
                <?= $arrow ?>
            </a>
        <?php endif; ?>
        ...
        <?php for ($i = $start; $i <= $end; $i++): ?>
            <?php if ($i == $currentPage): ?>
                <span class="pagination__number pagination__active">
                    <?= $i ?>
                </span>
            <?php else: ?>
                <a class="pagination__number" href="<?= $link($i) ?>">
                    <?= $i ?>
                </a>
            <?php endif; ?>
        <?php endfor; ?>
        ...
        <?php if ($currentPage < $totalPages): ?>
            <a class="pagination__arrow" href="<?= $link($totalPages) ?>">
                <?= $arrow ?>
            </a>
        <?php endif; ?>
    </div>
