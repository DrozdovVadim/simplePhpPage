...
/* infoblock ID=11, code=author */
class author extends Infoblock
{
...
return array(
	...
	return array(
            'REST_ON' => 'N',
            'LIST_PAGE_URL' => '#SITE_DIR#/books/index.php?ID=#IBLOCK_ID#',
            'DETAIL_PAGE_URL' => '#SITE_DIR#/books/detail.php?ID=#ELEMENT_ID#',
            'SECTION_PAGE_URL' => '#SITE_DIR#/books/list.php?SECTION_ID=#SECTION_ID#',
            'TMP_ID' => '6e39ffc7341820dfe3c7af3d17f96151',
            'INDEX_SECTION' => 'Y',
            'WORKFLOW' => 'N',
